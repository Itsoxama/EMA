...
ws['!rows']=wscolsd
       ...
       var wsx= XLSX.utils.sheet_add_aoa(ws3, [
            ...
            ["Invoice # 1235", '', '', '', '', '', '','','', '', 'Address2 bn',''],
            
            ["", '', '', '', '', '', '','','', '', 'Addresscvzzzzz',''],
            ["Address: Newyork city", '', '', '', '', '', '','','', '', '',''],
            
            ["", '', '', '', '', '', '','','', '', 'www.cfi-solutions.com',''],
          ], {
...
<button className='addemp3 addemp' onClick={e => preparesheet(2)}>Client invoice</button>
</div>
    </>
         ...
         <h1>Client : <p>{currproject.clientname}</p></h1>
